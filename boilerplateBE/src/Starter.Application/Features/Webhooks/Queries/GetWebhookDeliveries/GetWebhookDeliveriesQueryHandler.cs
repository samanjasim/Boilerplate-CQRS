...
namespace Starter.Application.Features.Webhooks.Queries.GetWebhookDeliveries;

internal sealed class GetWebhookDeliveriesQueryHandler(
    IApplicationDbContext context) : IRequestHandler<GetWebhookDeliveriesQuery, Result<PaginatedList<WebhookDeliveryDto>>>
{
