...
Integrator-facing integration docs live in [`developer-guide/modules/communication.md`](developer-guide.md). End-user docs live in [`user-manual/modules/communication.md`](user-guide.md). This file is maintainer-facing.
