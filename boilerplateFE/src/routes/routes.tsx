      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              children: [{ path: ROUTES.ROLES.CREATE, element: <RoleCreatePage /> }],
            },
            {
              element: (
                <PermissionGuard
              ...
              children: [{ path: ROUTES.ROLES.EDIT, element: <RoleEditPage /> }],
            },
            ...
            {
              element: <PermissionGuard permission={PERMISSIONS.Tenants.View} />,
              children: [{ path: ROUTES.ORGANIZATION, element: <TenantDetailPage /> }],
            },
            ...
            // Files
            {
              ...
              children: [{ path: ROUTES.FILES.LIST, element: <FilesPage /> }],
            },

            // Reports
            {
              element: <PermissionGuard permission={PERMISSIONS.System.ExportData} />,
              children: [{ path: ROUTES.REPORTS.LIST, element: <ReportsPage /> }],
            },

            // API Keys
            {
              element: <PermissionGuard permission={PERMISSIONS.ApiKeys.View} />,
              children: [{ path: ROUTES.API_KEYS.LIST, element: <ApiKeysPage /> }],
            },
            ...
            // Feature Flags
            {
              ...
              children: [
                {
                  path: ROUTES.FEATURE_FLAGS.LIST,
